...
def testIntent():
    # person
    print("[TEST] person")
    inputLIST = ['兩大兩小','總共兩位','我要兩大兩小','總共兩大兩小','兩位大人兩位小孩']
    testLoki(inputLIST, ['person'])
    print("")

    # time
    print("[TEST] time_basic")
    inputLIST = ['14:00','8/22/21:00','下午兩點','8/22晚上九點','明天晚上9:00','八月十號21:00','明天下午兩點']
    testLoki(inputLIST, ['time_basic'])
    print("")

    # phone
    print("[TEST] phone")
    inputLIST = ['0906671163']
    testLoki(inputLIST, ['phone'])
    print("")

    # name
    print("[TEST] name")
    inputLIST = ['張','張先生','張小姐','我姓張','我的名字是張小姐']
    testLoki(inputLIST, ['name'])
    print("")
