...
def testIntent():
    # phone_number_re
    print("[TEST] phone_number_re")
    inputLIST = ['0906671163','電話是0906671163','0906671163是我的電話號碼','我的電話號碼是0906671163']
    testLoki(inputLIST, ['phone_number_re'])
    print("")
